...
response = requests.get("https://controlelectoral.unionporlaesperanza.com/api/incidencias_combined_cne", headers=headers)
...
for incidencia in incidencias:
    ...
    try:
        ...
        if str(datetime_time) not in q.observaciones:
            q.observaciones=str(datetime_time) + "|"+ incidencia['tipo'] +" -->" +incidencia['descripcion'] +"\n"
